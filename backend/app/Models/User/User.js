...
// **التعديل هنا:** استخدام ثلاثة مستويات رجوع (../../../) لتجاوز مشاكل المسار
const securityPath = path.resolve(__dirname, '../../../config/security'); 
const { securityConfig } = require(securityPath);
